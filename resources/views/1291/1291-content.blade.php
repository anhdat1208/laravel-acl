                    ...
                    <div class="blog-box __post">
                        <div class="post-list">
                            <div class="post-list_box">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_img" style="background:url({{ asset('assets-1291/images/blog/1.jpg') }}"><a href="#"></a></div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                            ...
                            <div class="post-list_box">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_img" style="background:url({{ asset('assets-1291/images/blog/2.jpg') }}"><a href="#"></a></div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_info">
                            ...
                            <div class="post-list_box">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_img" style="background:url({{ asset('assets-1291/images/blog/3.jpg') }}"><a href="#"></a></div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_info">
                            ...
                            <div class="post-list_box">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_img" style="background:url({{ asset('assets-1291/images/blog/4.jpg') }}"><a href="#"></a></div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_info">
                            ...
                            <div class="post-list_box">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_img" style="background:url({{ asset('assets-1291/images/blog/5.jpg') }}"><a href="#"></a></div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                                        <div class="post-list_info">
